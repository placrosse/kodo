...
#include <kodo/has_const_shallow_symbol_storage.hpp>
#include <kodo/has_mutable_shallow_symbol_storage.hpp>
...
TEST(TestHasShallowSymbolStorage, detect)
{
    EXPECT_FALSE(kodo::has_shallow_symbol_storage<
                     kodo::dummy>::value);

    EXPECT_FALSE(kodo::has_shallow_symbol_storage<
                    kodo::deep_decoder>::value);

    EXPECT_FALSE(kodo::has_shallow_symbol_storage<
                    kodo::deep_encoder>::value);

    EXPECT_TRUE(kodo::has_shallow_symbol_storage<
                     kodo::shallow_decoder>::value);

    EXPECT_TRUE(kodo::has_shallow_symbol_storage<
                     kodo::shallow_encoder>::value);
}

/// Tests the has_const_shallow_symbol_storage template
TEST(TestHasConstShallowSymbolStorage, detect)
{
...
/// Tests the has_mutable_shallow_symbol_storage template
TEST(TestHasMutableShallowSymbolStorage, detect)
{
